...
// import { fetchProviderOutletById } from "@/lib/provider-outlets";
...
//                 className="flex-1"
//               >
//                 <a href={`tel:${provider.phone.replace(/\s/g, "")}`}>Call</a>
//               </Button>
//             )}
//             {provider.email && (
//               <Button
...
//     error,
//   } = useQuery({
//     queryKey: ["provider-outlet", slug],
//     queryFn: ({ signal }) => fetchProviderOutletById(slug!, { signal }),
...
//     let cancelled = false;
//     fetch(
//       `/api/profiles/claimed?outletKey=${encodeURIComponent(provider.outletKey)}`,
//     )
//       .then((res) => res.json())
